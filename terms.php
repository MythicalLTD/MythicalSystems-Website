...
<head>
    ...
    <title>MythicalSystems - Terms of Service</title>
...
<body>
    ...
    <p>When we refer to "MythicalSystems," we mean MythicalSystems LTD. By registering or purchasing services on
        ...
        <p>The minimum age to create an account or any activity that requires your personal data is 13 years old! If you
            are under 13, please contact us and request account deletion. Your personal data must be real. If not, your
            services may be suspended and your account banned. We reserve the right to request your identity
            card/passport/any document proving your details to verify your account details. If you do not provide it
            when we ask, your services will be suspended without refund and your account will be banned. We are not
            responsible for the security of your account. We recommend that you use a strong password and do not give it
            to anyone. If your account gets hacked/lost, we can only help you recover it. We will never sell your
            personal data.</p>

        <h2>Support:</h2>
        <p>We are under no obligation to install software / help you code on your site or any service got from
            MythicalSystems / other host! We only provide the service, you have to work on it. We are not responsible
            for your files. You are not allowed to SPAM / make jokes / offend our staff or any activity that wastes our
            time. We may suspend your services and ban your account. We are not offering support in Discord DM / any
            other social media, support is only offered through our Website. Any contact in Discord DM or any other
            social media will be ignored, further insistence will get you banned and your services suspended. You may
            not lie or slander MythicalSystems! You risk having our services suspended.</p>

        <h2>Service Activity:</h2>
        <p>You are not allowed to use our servers for illegal purposes like DDoS, mining etc. Your server will be
            suspended! We are not required to install software (Pterodactyl, GameCP, etc.) on your server. We only offer
            you the service. You have to work at it. You may not use our web hosting services or any hosting services to
            sell people/children/weapons/copyrighted content or any illegal activity. You will get your services
            suspended! We are under no obligation to help you code your site! Resource intensive users will not be
            supported in any form (eg: p2p communities - torrent trackers, file hosting sites, image hosting sites, site
            statistics installations (above), game statistics, installations external counters (redirecting players,
            etc.) will be suspended without refund! You may not disrupt the services of other customers. You risk having
            your services suspended and your account banned! We are not responsible for your website downtime. We will
            always let you know if there is a problem. We reserve the right to adapt the hardware and software used to
            provide the services to the current state of the art and to inform you in good time of any additional
            requirements that may arise from this for the content you have stored on our servers. We undertake to make
            such adjustments only to a reasonable extent and taking your interests into account. You are not allowed to
            resell our products, if you do so your service will be suspended without refund.</p>

        <h2>Data</h2>
        <p>We are not responsible for any backup/file or any data loss. You are responsible for backups and expired,
            suspended, canceled, refunded, prohibited services. We will never sell your personal data.
        </p>

        <h2>Limitation of Liability</h2>
        <p>In no event shall MythicalSystems be liable for any damages arising out of or in connection with the use of
            our services. We shall not be liable for any indirect, consequential, or punitive damages.</p>

        <h2>Changes to the Terms</h2>
        <p>MythicalSystems reserves the right to modify or replace these terms at any time. Your continued use of our
